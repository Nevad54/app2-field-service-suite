// Seed data for SQLite database - no external dependencies
const users = [
...
const jobs = [
 { id: 'JOB-1001', title: 'HVAC preventive maintenance', status: 'completed', priority: 'medium', assignedTo: 'tech-1', location: 'Building A - Acme Corp', scheduledDate: '2026-01-20', customerId: 'CUST-001', category: 'maintenance', notes: 'Quarterly maintenance completed', created_at: '2026-01-15T08:00:00Z' },
 { id: 'JOB-1002', title: 'Generator inspection', status: 'completed', priority: 'high', assignedTo: 'tech-3', location: 'Warehouse North - Global Logistics', scheduledDate: '2026-01-25', customerId: 'CUST-003', category: 'inspection', notes: 'All systems operational', created_at: '2026-01-18T09:00:00Z' },
 { id: 'JOB-1003', title: 'Electrical panel audit', status: 'in-progress', priority: 'high', assignedTo: 'tech-3', location: 'Main Plant - Midwest Mfg', scheduledDate: '2026-02-15', customerId: 'CUST-007', category: 'audit', notes: 'In progress - 60% complete', created_at: '2026-02-10T10:00:00Z' },
 { id: 'JOB-1004', title: 'Plumbing system check', status: 'assigned', priority: 'medium', assignedTo: 'tech-2', location: 'TechStart Office', scheduledDate: '2026-02-20', customerId: 'CUST-002', category: 'maintenance', notes: 'Scheduled for next week', created_at: '2026-02-12T11:00:00Z' },
 ...
 { id: 'JOB-1006', title: 'Elevator maintenance', status: 'assigned', priority: 'medium', assignedTo: 'tech-1', location: 'Sunset Hotels - Main Building', scheduledDate: '2026-02-18', customerId: 'CUST-006', category: 'maintenance', notes: 'Quarterly maintenance', created_at: '2026-02-08T14:00:00Z' },
 { id: 'JOB-1007', title: 'Security system upgrade', status: 'in-progress', priority: 'high', assignedTo: 'tech-3', location: 'Riverside School District', scheduledDate: '2026-02-10', customerId: 'CUST-005', category: 'installation', notes: 'Installing new access control', created_at: '2026-02-05T09:00:00Z' },
...
const notifications = [
 { id: 'notif-001', user_id: 'admin', type: 'info', title: 'Job Completed', message: 'HVAC preventive maintenance completed successfully', read: 0, created_at: '2026-01-20T10:30:00Z' },
 { id: 'notif-002', user_id: 'admin', type: 'info', title: 'Payment Received', message: 'Invoice INV-2026-001 has been paid', read: 1, created_at: '2026-01-25T14:00:00Z' },
 { id: 'notif-003', user_id: 'admin', type: 'info', title: 'New Job Assigned', message: 'New job: Electrical panel audit assigned to technician', read: 0, created_at: '2026-02-10T10:00:00Z' },
];
